...
Definicion : Se define _funciones marginales_ de un vector aleatorio de dos variables como
...
Nota : Para hallar la funcion de densidad conjunta de un vector aleatorio dada la funcion de distribucion, entonces basta con
       derivar F con cada una de las variables aleatorias.
